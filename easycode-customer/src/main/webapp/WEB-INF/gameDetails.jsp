			...
			<div class="container">
				...
				<div class="content-top hidden-sm hidden-xs">
					<ul style="margin-bottom: 0;">
						<li>
							<p class="game-title">太空飞人</p>
						</li>
						<li><span class="game-writer">王潘安</span></li>
					</ul>
						...
						<div class="col-md-6 col-sm-12 hidden-xs content-middle-right">
								...
								<ul>
									...
									<li class="game-introduce-content">
										<p style="overflow-y: auto;height: 120px;">
											山姆大叔乘坐阿波罗飞船到太空执行一项重要的任务：收集太空垃圾！山姆大叔穿着舱外机动套装（EMU）进行太空行走。由于失重的原因，山姆大叔一直在旋转，只能通过推进器向前移动。现在，你要帮助山姆大哥移动到想要的位置。看准山姆大叔的朝向，点击鼠标或按下空格键，帮助山姆大叔完成任务吧！注意避开偶尔出现的小怪物哦！【转载】 山姆大叔乘坐阿波罗飞船到太空执行一项重要的任务山姆大叔乘坐阿波罗飞船到太空执行一项重要的任务山姆大叔乘坐阿波罗飞船到太空执行一项重要的任务山姆大叔乘坐阿波罗飞船到太空执行一项重要的任务山姆大叔乘坐阿波罗飞船到太空执行一项重要的任务
										</p>
									</li>
								</ul>
							</div>
							...
							<div class="col-md-12 col-sm-12 game-instruction">
								<ul>
									...
									<li class="game-instruction-content">
										<p>看准山姆大叔的朝向，点击鼠标左键或者按下空格键，帮助山姆大叔收集太空垃圾吧！ 看准山姆大叔的朝向，点击鼠标左键或者按下空格键，帮助山姆大叔收集太空垃圾吧！ 看准山姆大叔的朝向，点击鼠标左键或者按下空格键，帮助山姆大叔收集太空垃圾吧！ 看准山姆大叔的朝向，点击鼠标左键或者按下空格键，帮助山姆大叔收集太空垃圾吧！ 看准山姆大叔的朝向，点击鼠标左键或者按下空格键，帮助山姆大叔收集太空垃圾吧！
							...
							<div class="col-md-12 col-sm-12 content-other hidden-sm hidden-xs">
								<div class="col-md-6 col-sm-6 choose-make">
									<!--改编form提交-->
									<form action="http://baidu.com" method="post" class="col-md-6 col-sm-12">
										<input type="hidden" name="" id="" value="" />
										<a href="javascript:" id="game-choose">
											<input type="submit" value="改编" :disabled="isPublic==1" :class="{'prohibit':isPublic==1}" />
										</a>
									</form>
									...
									<form action="http://baidu.com" method="post" class="col-md-6 col-sm-12">
										<input type="hidden" name="" id="" value="" />
										<a href="javascript:">
											<input type="submit" value="查看创作页" :disabled="isPublic==1" :class="{'prohibit':isPublic==1}" />
										</a>
									</form>
								...
								<div class="col-md-6 col-sm-6 posted-updata">
									<ul>
										<li class="clearfix" style="text-align: right;">
											<span class="col-md-6 col-ms-12">发布于：2017-07-13</span>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 view-share">
						<div class="col-md-6 col-sm-9 col-xm-9 content-bottom-left">
							...
							<div class="col-sm-3" id="dianzan" @click="isThumbsup">
								...
								<div class="dianzan  dianzan1" :class={ 'togzan':isLike==false}>
									<i class="fa  fa-thumbs-o-up" :class={ 'togzan':isLike==false}></i>
									<span>200</span>
								</div>

							</div>
							<div class="col-sm-3">
								<div class="dianzan  dianzan2" :class={ 'togcoll':isCollection==false} id="collection" @click="collection">
									<i class="fa fa-heart-o" :class={ 'togcoll':isCollection==false}></i>
...
<script type="text/javascript">
	new Vue({
		...
		data: function() {
			return {
				resultData: [],
				isPublic: 0, //为1的时候 改编和查看 创作页可以点击 ,为0的时候不允许点击  按钮颜色为灰色
				commens: [],
				content: '', //主评论框的内容
				currentActive: -1,
				current: -1,
		...
		methods: {
			...
			isThumbsup: function() {
				...
				if(!_this.up) {
					...
					//点赞的时候请求的接口
					if(_this.isLike == false) {
						$.ajax({
							type: "post",
							url: "http://www.maomi.xn--fiqs8s/cancelUpvote",
							data: {
						...
						//没有点赞的时候请求的接口
					} else if(_this.isLike == true) {
						$.ajax({
							type: "post",
							url: "http://www.maomi.xn--fiqs8s/upvote",
							data: {
								projectId: window.location.href.split('=')[1]
							},
							success: function(res) {
			...
			collection: function() {
				...
				if(!_this.up) {
					...
					if(_this.isCollection == false) {
						$.ajax({
							type: "post",
							url: "http://www.maomi.xn--fiqs8s/cancelEnshrine",
							data: {
								projectId: window.location.href.split('=')[1]
							},
							success: function(res) {
						...
						//收藏的时候请求的接口
					} else if(_this.isCollection == true) {
						$.ajax({
							type: "post",
							url: "http://www.maomi.xn--fiqs8s/enshrine",
							data: {
								projectId: window.location.href.split('=')[1]
							},
							success: function(res) {
			...
			browse: function() {
				...
				$.ajax({
					type: "post",
					url: "http://www.maomi.xn--fiqs8s/browse",
					data: {
						projectId: window.location.href.split('=')[1]
					},
					success: function(res) {
			...
			commen: function() {
				...
				$.ajax({
					type: "POST",
					url: "http://www.maomi.xn--fiqs8s/comment",
					async: true,
					data: {
						projectId: window.location.href.split('=')[1],
						pageCurrent: 1,
			...
			reply: function() {
				...
				if(!_this.up) {
					...
					if(!this.content) {
						...
						$.ajax({
							type: "post",
							url: "http://www.maomi.xn--fiqs8s/addComment",
							async: true,
							data: {
								projectId: window.location.href.split('=')[1], // 作品的id
								commentuserid: 1520046492952, //评论者用户ID 
								commentcontent: this.content, //评论的内容
								parentid: window.location.href.split('=')[1] //评论对象的ID
							},
							success: function(res) {
								_this.isLoding = false //隐藏loding
			...
			queryLike: function() {
				...
				if(_this.up) {
					$.ajax({
						type: "post",
						url: "http://www.maomi.xn--fiqs8s/queryFeatured",
						async: true,
						success: function(res) {
							//成功
							_this.isLike = false
			...
			isSgouji: function() {
				if(/Android|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent)) {
					...
					$.ajax({
						type: "post",
						url: "http://www.maomi.xn--fiqs8s/getDetails/" + window.location.href.split('=')[1],
						success: function(res) {
							data = res.data
							window.location.href = "sc/sc.html?data=" + JSON.stringify(data)
						}
					});
				}
